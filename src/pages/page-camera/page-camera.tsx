              ...
              <div className="container">
                <div className="product__img">
                  <picture>
                    <source
                      type="image/webp"
                      srcSet={currentCard.previewImgWebp2x}
                    />
                    <img
                      src={currentCard.previewImg}
                      srcSet={currentCard.previewImg2x}
                      width={560}
                      height={480}
                ...
                <div className="product__content">
                  <h1 className="title title--h3">{currentCard.name}</h1>
                  <div className="rate product__rate">
                    <CardRating count={currentCard.rating} />
                    <p className="visually-hidden">Рейтинг: {currentCard.rating}</p>
                    <p className="rate__count">
                      <span className="visually-hidden">Всего оценок:</span>{currentCard.reviewCount}
                    </p>
                  </div>
                  <p className="product__price">
                    <span className="visually-hidden">Цена:</span>{currentCard.price} ₽
                  </p>
                      ...
                      <div className="tabs__element">
                        <ul className="product__tabs-list">
                          <li className="item-list">
                            ...
                            <p className="item-list__text">{currentCard.vendorCode}</p>
                          </li>
                          <li className="item-list">
                            <span className="item-list__title">Категория:</span>
                            <p className="item-list__text">{currentCard.category}</p>
                          </li>
                          <li className="item-list">
                            <span className="item-list__title">Тип камеры:</span>
                            <p className="item-list__text">{currentCard.type}</p>
                          </li>
                          <li className="item-list">
                            <span className="item-list__title">Уровень:</span>
                            <p className="item-list__text">{currentCard.level}</p>
                          </li>
                        </ul>
                      </div>
